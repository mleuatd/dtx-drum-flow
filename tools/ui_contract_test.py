...
checks = {
    ...
    "character module cache bust": 'character-prototype.js?v=20260916-full-song' in js and 'app.js?v=20260916-full-song' in html and 'styles.css?v=20260916-full-song' in html,
