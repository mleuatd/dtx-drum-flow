...
checks = {
    ...
    "character module cache bust": 'character-prototype.js?v=20260916-2100' in js and 'app.js?v=20260916-2100' in html and 'styles.css?v=20260916-2100' in html,
    ...
    "first eight measure runtime scope": 'inventory.runtimeScope?.measureEnd||8' in character_js and 'note.measure>=startMeasure&&note.measure<=endMeasure' in character_js,
