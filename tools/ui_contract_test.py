...
checks = {
    ...
    "character module cache bust": 'character-prototype.js?v=20260917-android-character-visible-r4' in js and 'app.js?v=20260917-android-character-visible-r4' in html,
    ...
    "character assets preload": 'Promise.allSettled(sources.map(loadImage))' in character_js and 'character-ready' in character_js,
    "character preload failure does not hide layer": 'asset-warning' in character_js and 'if(!ready||!data)return' in character_js,
