...
for(const r of selected)r.screenshotStem=(phase,viewport)=>"m"+r.measure+"_"+r.time.toFixed(6)+"__p_"+slug(r.previousKey||"none")+"__c_"+slug(r.currentKey)+"__n_"+slug(r.nextKey||"none")+"__"+phase+"__"+viewport;
