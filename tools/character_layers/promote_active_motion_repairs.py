...
summary_path=WORK/"AUTO_REPAIR_CANDIDATE_SUMMARY.json"
...
for d in backlog.get("defects",[]):
    ...
    if p:
        d["autoRepairPromotion"]={"promoted":p,"method":"neutral-locked semantic corridor + changed-ink/alpha transplant","candidateSummary":str(summary_path.relative_to(ROOT))}
